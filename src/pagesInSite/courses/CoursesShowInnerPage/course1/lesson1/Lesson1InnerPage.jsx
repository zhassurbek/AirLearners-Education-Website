...
const LessonPage = () => {
    ...
    return (<section>
        ...
        <div className="container">
            ...
            <Link to="/lesson/quiz/01" style={{margin: '20px', color: '#ffffff', backgroundColor: '#00ab1e', borderRadius: '5px', textDecoration: 'none', paddingBottom: '20px', padding: '8px', textAlign: 'center', fontSize: '25px'}}>Пройти тест</Link>
