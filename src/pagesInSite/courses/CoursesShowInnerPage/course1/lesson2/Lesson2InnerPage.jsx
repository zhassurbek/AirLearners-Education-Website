...
const LessonPage = () => {
    ...
    const [lessonDescription, setLessonDescription] =
        useState('' +
            '<div>\n' +
            '  <h3>Урок 2</h3>\n' +
            '  <p>Урок 2, пульты и панели управления являются важными элементами электронных систем и приборов. Они используются в широком спектре приложений, начиная от авиационных и автомобильных приборных панелей до промышленных систем управления и систем безопасности.</p>\n' +
